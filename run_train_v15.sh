#!/bin/bash
# RL Layer B v15: SL pretrain + RL finetune
set -e
...
CONFIG=/mnt/f/Dev/AIstock/rl_execution/config/train_ppo_v15.yaml
LOG=/mnt/f/Dev/AIstock/rl_data/train_v15.log

mkdir -p /mnt/f/Dev/AIstock/rl_data/checkpoints_v15

echo "Starting v15 training at $(date)" >> "$LOG"

nohup $CONDA_BIN -u /mnt/f/Dev/AIstock/scripts/rl_execution/train_v15.py \
    --config "$CONFIG" \
    >> "$LOG" 2>> "$LOG" &
