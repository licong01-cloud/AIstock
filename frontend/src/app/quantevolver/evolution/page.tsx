...
export default function EvolutionDashboard() {
  ...
  const [customEvoEngineMode, setCustomEvoEngineMode] = useState<"legacy" | "unified">("unified");
      ...
      if (newTask.source_type === "custom_evo") {
        ...
        const res = await fetch(`${API}/quantevolver/evolution/custom-tasks`, {
          ...
          body: JSON.stringify({
            ...
            engine_mode: customEvoEngineMode,
          }),
        });
        if (!res.ok) {
          const errText = await res.text();
