    ...
    <main>
      ...
      <div className="pv2-grid pv2-grid-2">
        <SectionCard title="支持流程" eyebrow="权威入口">
          <ol>
            ...
            <li>执行单策略包或多策略包选股；只有单策略包选股可以创建模拟盘 v2 组合。</li>
            <li>创建组合并冻结策略包、manifest hash、资金、数据源和已验证执行策略。</li>
      ...
      <div className="pv2-grid pv2-grid-3">
        ...
        <SectionCard title="选股中心 API" eyebrow="后端">
          ...
          <p>可选策略包、单策略包选股、动态并集/交集/加权融合、剔除结果追踪和单策略包组合创建。</p>
        ...
        <SectionCard title="模拟盘 v2 API" eyebrow="后端">
          ...
          <p>组合生命周期、就绪检查、单日运行、回放/重置、执行策略激活、账本产物、错误和绩效报告。</p>
          <Link className="pv2-button" href="/paper-v2/portfolios">打开组合中心</Link>
        </SectionCard>
      </div>
    </main>
  );
