...
class SimulationLifecycleScheduler:
    ...
    def _local_sim_projection_state_contract(
        ...
        *,
        ...
        return derive_local_sim_projection_state_contract(
            execution_states=execution_states,
            historical_residual=historical_residual,
            intraday_status=SimulationDailyRunStatus.INTRADAY_RUNNING,
            failed_status=SimulationDailyRunStatus.FAILED_TERMINAL,
            succeeded_status=SimulationDailyRunStatus.SUCCEEDED,
        )
    ...
    def _local_sim_projection_paper_error(
        *,
        ...
        return local_sim_projection_paper_error(
            historical_residual=historical_residual,
            nonfilled_terminal_states=nonfilled_terminal_states,
            terminal_failure=terminal_failure,
        )
    ...
    def _local_sim_projection_payload(
        *,
        ...
        return build_local_sim_projection_payload(
            binding=binding,
            run=run,
            execution=execution,
            context=context,
    ...
    def _project_local_sim_valuation_pending_outbox(
        ...
        *,
        ...
        return LocalSimValuationCoordinator(
            runtime_repository=self.repository,
            paper_repository=paper_repository,
