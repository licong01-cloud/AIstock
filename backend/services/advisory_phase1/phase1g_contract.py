...
REASON_PLAN_STALE = "ADVISORY_PHASE1G_PLAN_STALE"
REASON_TARGET_DIAGNOSTIC = "ADVISORY_PHASE1G_TARGET_DIAGNOSTIC"
REASON_OPERATION_DEFERRED = "ADVISORY_PHASE1G_OPERATION_DEFERRED"
REASON_BATCH_IN_PROGRESS = "ADVISORY_PHASE1G_BATCH_IN_PROGRESS"
REASON_BATCH_STATE_CONFLICT = "ADVISORY_PHASE1G_BATCH_STATE_CONFLICT"
REASON_CAPTURE_TIMEOUT = "ADVISORY_PHASE1G_CAPTURE_TIMEOUT"
...
REASON_BATCH_RECEIPT_STORE_FAILED = "ADVISORY_PHASE1G_BATCH_RECEIPT_STORE_FAILED"
...
class Phase1GAttemptReceipt(_StrictContract):
    ...
    def _validate_receipt(self) -> "Phase1GAttemptReceipt":
        ...
        if set(self.committed_phases) - set(PHASE1G_COMMITTED_PHASES):
            raise ValueError("committed_phases contains an unregistered phase")
        batch_values = (
