...
BEGIN
    ...
    IF present_count=7 THEN
        ...
        IF actual_catalog_sha256 <> 'f9985b5c93aae9655d78179cf39e9ffd840ba095d1a91a6a34d0186beafbf198' THEN
            RAISE EXCEPTION 'K6-A preflight: K6 catalog drift: expected f9985b5c93aae9655d78179cf39e9ffd840ba095d1a91a6a34d0186beafbf198, got %', actual_catalog_sha256;
        END IF;
...
SELECT 'canonical_lf_forward_sha256' AS verification,
       '4ce8492f2c6f6c25a3cfcad79d74e24ef31cbc2d0bfa7b2c41087b33ca0f0031'::TEXT AS expected_migration_sha256;
