...
from backend.services.advisory_model_first.grouped_rank_output_constraint_pipeline import (
    _attach_labels,
    _train_p0d_oof,
...
def test_p0d_oof_uses_each_fold_train_and_score_dates_once(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "backend.services.advisory_model_first.grouped_rank_output_constraint_pipeline."
