...
def list_stocks(auto_monitor_only: bool = Query(False)) -> List[Dict[str, Any]]:
...
def add_stock(payload: PortfolioStockCreate) -> Dict[str, Any]:
...
def update_stock(stock_id: int, payload: PortfolioStockUpdate) -> Dict[str, Any]:
...
def batch_analyze(payload: BatchAnalyzeRequest) -> Dict[str, Any]:
...
def latest_all_analysis() -> List[Dict[str, Any]]:
...
def update_scheduler_config(payload: SchedulerConfigPayload) -> Dict[str, Any]:
    # 先更新时间列表
