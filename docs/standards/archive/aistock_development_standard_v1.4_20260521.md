...
> 当前文件：`docs/standards/aistock_development_standard_v1.4_20260521.md`
> 同步机器版本：`docs/standards/aistock_development_standard_v1.4_20260521.yaml`
...
| 文件 | 角色 | 权威性 | 说明 |
|---|---|---:|---|
| `docs/standards/aistock_development_standard_v1.4_20260521.md` | 人类可读规范源 | 最高 | 定义必须遵守的项目开发、量化、测试和提交流程。 |
| `docs/standards/aistock_development_standard_v1.4_20260521.yaml` | 机器可读同步版本 | 派生 | 由本文抽取规则，供 guardrail scanner、nox、Validation Center、Codex/Claude Code 使用。 |
...
本节中的规则 ID 必须与 `docs/standards/aistock_development_standard_v1.4_20260521.yaml` 保持一致。
