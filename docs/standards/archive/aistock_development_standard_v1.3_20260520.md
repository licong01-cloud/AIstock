...
> 版本：1.3
> 更新日期：2026-05-20
> 状态：人类可读规范源；本版在 v1.2 基础上补充设计方案完整实现复核、禁止简化交付和合入前验收矩阵要求
> 当前文件：`docs/standards/aistock_development_standard_v1.3_20260520.md`
> 同步机器版本：`docs/standards/aistock_development_standard_v1.3_20260520.yaml`
...
| 文件 | 角色 | 权威性 | 说明 |
|---|---|---:|---|
| `docs/standards/aistock_development_standard_v1.3_20260520.md` | 人类可读规范源 | 最高 | 定义必须遵守的项目开发、量化、测试和提交流程。 |
| `docs/standards/aistock_development_standard_v1.3_20260520.yaml` | 机器可读同步版本 | 派生 | 由本文抽取规则，供 guardrail scanner、nox、Validation Center、Codex/Claude Code 使用。 |
...
本节中的规则 ID 必须与 `docs/standards/aistock_development_standard_v1.3_20260520.yaml` 保持一致。
