...
> 版本：1.1
> 更新日期：2026-05-04
> 状态：人类可读规范源；本版补充项目目录、脚本归属、文档归属、Python 最佳实践、资源/内存和算法复杂度规范
> 当前文件：`docs/standards/aistock_development_standard_v1.1_20260504.md`
> 同步机器版本：`docs/standards/aistock_development_standard_v1.1_20260504.yaml`
...
| 文件 | 角色 | 权威性 | 说明 |
|---|---|---:|---|
| `docs/standards/aistock_development_standard_v1.1_20260504.md` | 人类可读规范源 | 最高 | 定义必须遵守的项目开发、量化、测试和提交流程。 |
| `docs/standards/aistock_development_standard_v1.1_20260504.yaml` | 机器可读同步版本 | 派生 | 由本文抽取规则，供 guardrail scanner、nox、Validation Center、Codex/Claude Code 使用。 |
...
本节中的规则 ID 必须与 `docs/standards/aistock_development_standard_v1.1_20260504.yaml` 保持一致。
