...
| DEF-06 | `qe_evolution_service.py:133` scheduler; `qe_evolution_service.py:1600` 单 loop 提交; `qe_evolution_service.py:5243` 被动 custom/rerun 入口 | 缺陷仍成立，无跨 loop 自主闭环、停止条件、预算守护 |
