...
- 初版日期：2026-07-10
- 当前版本：v5.22（F-014 现行进程身份已修正，runtime contract 与真实 historical preview GET 已在当前进程复核；normal Loop、browser visual/Phase 5 待后续，2026-07-31）
...
| F-014 长期趋势评价层 | `PHASE4_TASK_PROFILE_INPUT_PREVIEW_PROD_DDL_RUNTIME_API_VERIFIED_NORMAL_LOOP_VISUAL_PHASE5_PENDING` | PR #2906 source/CI merged；生产 DDL reconnect readback；当前 8001 OpenAPI 已加载 profile/preview；固定 task `qe_20260715_104922_001d` Loop 4 live GET 返回 200、8/11 可用，feature identity/orders/trades typed missing，`research_gate=false`；DB 保持 17 evaluation/2,004 metric/6 artifact，7 个 side-effect flags 全 false；3000 HTTP 200 | normal Loop activation smoke、完整 root/runtime SHA 对齐、browser visual、其余 5 个 R8B、Phase 5 与批量重评尚未完成；缺输入不形成研究门禁。source/docs worktree/branch 保留待独立清理授权。 |
