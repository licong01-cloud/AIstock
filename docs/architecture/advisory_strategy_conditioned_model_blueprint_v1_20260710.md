# AIstock 荐股策略条件化模型体系 F2 架构蓝图 v3.64

> 初始日期：2026-07-10
> 修订日期：2026-09-15
> 文档类型：F2 顶层架构蓝图，`docs-fast-update`
> 当前状态：`P0_FAMILY_FROZEN_ADVISORY_ALPHA_EXPERIMENT_LINE_CLOSED_DAILY_PRICE_ENVELOPE_HISTORICAL_REPLAY_VERIFIED_PROSPECTIVE_CAPTURE_AWAITING_NATURAL_SETTLEMENT_NOT_ACTIVATED_QE_EXPERIMENTS_EXTERNALLY_OWNED`
