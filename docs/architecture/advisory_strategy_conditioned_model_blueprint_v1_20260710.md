...
| P0-D meta-label | request v2 `advmetareq_79e5762652462ae5855b3be7`；bundle `86bdda151dd0a0b631cc400a074ec9481042482bace0df4d5e45eb243c376317` | 2 families × 3 seeds × 28 paths = 168；winner `FAMILY_CORE_HMM/20260817` | 317.812 秒；RSS 2.86GB；exact retry 4.067 秒；双 root 12/12 identity hashes 一致 | winner `19.4357 bps` vs Selection `15.7801 bps`，lift `+3.6556 bps`，path win rate `64.29%`，PBO `0.40`，AUC `0.5142` | 真实模型已训练，保持 `EXPERIMENTAL_MODEL/UNCALIBRATED/NOT_ACTIVATED`；源码待 PR/合入 |
