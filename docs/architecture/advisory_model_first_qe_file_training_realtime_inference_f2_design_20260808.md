...
| F-314 | `model_inference.py`; `realtime_feature_source.py`; `advisory_program.py`; `backend/routers/advisory.py` | `backend/tests/advisory_model_first/test_model_inference.py`; `backend/tests/advisory_model_first/test_realtime_feature_source.py`; `backend/tests/watchlist/test_advisory_binding_lifecycle.py`; real read-only Program/ReviewRun/Selection/DB inference for 2026-07-16 | verified | none |
