...
- 状态：W0～W2与W3-A源码已合入；W3-B已获授权并在独立分支完成实现与相邻回归，最终HEAD审核进行中，尚未创建PR或合入；W3-C、真实数据构建和生产激活均未授权
...
| W3消费者源码 | `w3a_merged_w3b_final_head_review_in_progress_w3c_not_started` |
