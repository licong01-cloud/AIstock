...
- 2026-08-03 final-architecture-only revision：`design_revision_ready + merged`、`source_merge=merged_pr_3098`，merge `b986e8f655137e9aea88f17ea91d3eb153f1c017`。K6源码切片按A/C0/C1/B/D口径=`3/5`（60%）；严格完成的K6验收项为F-102/F-104/F-105/F-106=`4/12`，F-110=`design_ready`且只保留C1部分证据；产品runtime cutover=`0%`。后续研发预算100%归属最终KERNEL_V2的K6-B/K6-D，legacy维护、parity、bridge、backport、C2和额外shadow预算=`0`。
