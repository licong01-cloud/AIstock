...
> K6-D 唯一下位实施合同：[`miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`](miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md)，当前=`design_ready + merged`、PR #3129、merge `5b1e1477c98fedbc1361b5551133fcb3075bb2b3`、code=`not_started`、`source_merge=merged_pr_3129`。
>
...
- 唯一下位实施合同为 [`miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`](miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md)，当前=`design_ready + merged`、PR #3129、merge `5b1e1477c98fedbc1361b5551133fcb3075bb2b3`、code=`not_started`、`source_merge=merged_pr_3129`。
...
| `F-107` | §4.3、§9.1、§9.3；K6-D detailed §3–§5 | target `backend/tests/miniqmt_execution_runtime/test_kernel_product_cutover.py` binding/owner/cutoff/drain/rollback matrix | design_ready | none |
| `F-108` | §9.2；K6-D detailed §2.2、§6 | target `backend/tests/miniqmt_execution_runtime/test_kernel_legacy_route_retirement.py` exact inventory + AST/import/call-graph uniqueness | design_ready | none |
| `F-109` | §10；K6-D detailed §7 | target `backend/tests/miniqmt_execution_runtime/test_kernel_product_diagnostics.py`; artifact: `docs/operations/simulation_platform_operator_runbook_20260717.md` | design_ready | none |
| `F-110` | §11；K6-D detailed §8 | `backend/tests/miniqmt_execution_runtime/test_kernel_product_runtime_integration.py`、`backend/tests/simulation_runtime/test_lifecycle_scheduler.py`；K6-D target direct/DEV/coverage/route uniqueness/frozen-input与normal trading day receipts | design_ready | none |
| `F-111` | §12–§13；K6-D detailed §9–§10 | artifact: 本文、父蓝图、统一蓝图与K6-D下位详细设计；后续K6-D source/production/runtime states分离 | design_ready | none |
| `F-112` | §16–§17；K6-D detailed §13–§14 | artifact: `docs/architecture/miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`；DESIGN-COMPLIANCE-001 + K6-D normal trading day acceptance receipt | design_ready | none |
...
- K6-A implementation：`implemented_verified + merged`，`source_merge=merged_pr_3004`，merge `a59a9fc2d3f5365ad5ac2d1c8fc72ed5438d5401`，required CI run `30687689439` green。K6-C0=`implemented_verified + merged`、`source_merge=merged_pr_3032`，merge `2a3622a3ba63585e3dfe12ef7ccb3f33b00dcb63`，required CI run `30732380227` green；BUG-953=`implemented_verified + merged + runtime_verified`、`source_merge=merged_pr_3048`，Issue #3045已关闭；K6-C1=`implemented_verified + merged`、`source_merge=merged_pr_3080`，merge `c0ca2e7e356a891ee5b2aad270d391071c942ae4`，required CI run `30804132306` green；K6-B=`implemented_verified + merged`、`source_merge=merged_pr_3120`，merge `48bcf1153dea3dca5c598793d6556d2757ed87de`，required CI run `30844554277` green；K6-D detailed design=`design_ready + merged`、PR #3129、merge `5b1e1477c98fedbc1361b5551133fcb3075bb2b3`、`source_merge=merged_pr_3129`、code=`not_started`，K6 overall=`implementation_in_progress`。
