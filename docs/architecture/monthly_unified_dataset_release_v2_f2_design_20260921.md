...
| `aistock_node_release_registration_v2` | node_id、release_id、dataset_manifest_ref、closure_ref、candidate_root、relative_file_refs、deployment_receipt_ref、runtime_registration |
