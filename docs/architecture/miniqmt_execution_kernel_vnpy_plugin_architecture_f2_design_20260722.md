...
>
> K6-D 唯一下位详细设计：[`miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`](miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md)，当前=`design_ready + merged`、PR #3129、merge `5b1e1477c98fedbc1361b5551133fcb3075bb2b3`、code=`not_started`、`source_merge=merged_pr_3129`。
>
...
| `F-107` | K6 detailed §4.3/§9；K6-D detailed §3–§5 | `backend/tests/miniqmt_execution_runtime/test_kernel_product_cutover.py` strict existing binding/release identity、owner/cutoff/drain/rollback matrix | design_ready | none |
| `F-108` | K6 detailed §9.2；K6-D detailed §2.2/§6 | `backend/tests/miniqmt_execution_runtime/test_kernel_legacy_route_retirement.py` exact inventory + AST/import/call-graph uniqueness | design_ready | none |
| `F-109` | K6 detailed §10；K6-D detailed §7 | `backend/tests/miniqmt_execution_runtime/test_kernel_product_diagnostics.py`; artifact: `docs/operations/simulation_platform_operator_runbook_20260717.md` | design_ready | none |
| `F-110` | K6 detailed §11；K6-D detailed §8 | `backend/tests/miniqmt_execution_runtime/test_kernel_product_runtime_integration.py`、`backend/tests/simulation_runtime/test_lifecycle_scheduler.py`；K6-D target DEV/uniqueness/frozen-input/coverage/normal-day receipts | design_ready | none |
| `F-111` | K6 detailed §12–§13；K6-D detailed §9–§10 | artifact: `docs/architecture/miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`；source/production/runtime分离receipts | design_ready | none |
| `F-112` | K6 detailed §16–§17；K6-D detailed §13–§14 | artifact: `docs/architecture/miniqmt_execution_kernel_k6d_final_route_cutover_f2_detailed_design_20260804.md`；DESIGN-COMPLIANCE-001 + K6-D normal trading day acceptance receipt | design_ready | none |
...
| production state separation | pass | K2/K3/K4/K5 overall=`implemented_verified + merged`；K6-A/C0/C1/B均已合入，K6-B=`source_merge=merged_pr_3120`，K6-D detailed=`design_ready + merged`、PR #3129 / merge `5b1e1477c98fedbc1361b5551133fcb3075bb2b3`、`source_merge=merged_pr_3129`、code=`not_started`；final-architecture-only revision=`design_revision_ready + merged`、`source_merge=merged_pr_3098`；产品runtime未切换，predecessor与K6-B successor production DDL=`applied_and_verified`，K6-D new DDL/DML/config/binding=`noop`，dependency gate=`noop`，broker/restart/runtime activation/normal-day observation=`not_run` |
