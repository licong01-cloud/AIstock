...
- 当前详细设计=`design_ready_for_implementation`、PR #2816 / merge `d4a7fb2c8d4fcb191d75addd3fbc0faef2632b8e`、`source_merge=merged_pr_2816`，K3 implementation=`not_started`；
