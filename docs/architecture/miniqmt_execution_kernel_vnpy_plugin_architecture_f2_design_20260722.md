...
| production state separation | pass | K2/K3/K4/K5 overall=`implemented_verified + merged`；K6 design=`design_ready_local_pending_pr`、implementation=`not_started`；产品runtime未切换，DDL/DML/dependency/config/binding/broker/restart/runtime activation/normal-day observation全部为`noop/not_run` |
