...
| `F-110` | K6 detailed design §11 | `python -m nox -s miniqmt_execution_runtime_l2`=`1226 passed,60 skipped`；C1 direct+DEV=`39 passed`；authority line/branch=`87.76%/81.48%`、repository=`87.50%/70.95%` | k6c1_implemented_verified_local | none |
