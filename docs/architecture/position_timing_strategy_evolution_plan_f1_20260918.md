...
下一研究不沿本轮结果扫描止盈比例或混搭“最佳”组件。优先修正方法学可识别性：把历史特征热身可见性与当日交易资格拆分，形成一个独立、预注册且同人口BH的对照，目标是减少全人口unknown而不是追收益。随后才可把C2“无加速止盈、风险退出保留”作为一个新外部验证候选；50～500亿元市值、业绩增长加速等基础筛选必须在独立PIT人口上同时重算择时与BH，不能把选股alpha归给择时。模型、HMM、新闻/Agent和QE融合仍不在这一正确性主线之前。
