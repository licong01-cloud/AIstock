...
| `F-070` | §9 P0-H K2 detailed §11–§13 | `python -m nox -s miniqmt_execution_runtime_l2`与`backend/tests/miniqmt_execution_runtime/test_kernel_repository_postgres.py`：K2-B source=`84ce557c...`、PR #2773 / merge=`db81b27e...`、CI=`30225853616`，focused/DEV/single-process/L2=`50/14/794/772 passed`、核心line/branch=`85.99%/70.38%`；K2-C/D仍待证据 | design_ready | none |
