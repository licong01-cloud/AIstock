...
| `production state separation` | pass | K1-B/K1-C与K2/K3/K4/K5 source merge已闭合；K5 design source已合入PR #2968，implementation已合入PR #2978 / merge `4bf54cf2`；DDL/DML/dependency/config/binding/restart/broker与runtime evidence继续分开且均为`noop`，产品runtime未切换 |
