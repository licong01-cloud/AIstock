...
| `F-062` | §9 P0-H K2 detailed §4.0–§4.10、§9、§12 K2-A-M1；strict carriers、唯一public repository façade、private responsibility modules与migration triplet | `backend/tests/miniqmt_execution_runtime/test_kernel_repository_structure.py`=`4 passed`、`test_kernel_contracts.py`=`33 passed`、`test_kernel_repository_postgres.py` DEV=`12 passed`、`test_kernel_migration_postgres.py` DEV=`11 passed`；public signature SHA-256=`7045f3c2...`，migration bytes=`785d438d.../f6331a8a.../7ab20353...` | design_ready | none |
...
| `F-070` | §9 P0-H K2 detailed §11–§13 | `python -m nox -s miniqmt_execution_runtime_l2`=`723 passed,21 skipped`；structure/contracts/DEV repo/DEV migration/import=`4/33/12/11/66 passed`、combined=`49 passed`、aggregate coverage=`87.83/72.04`；`scripts/ci_change_classifier.py`仅MiniQMT且unmapped=0，`python -m nox -s l0`与`validation_module_registry_l0`通过，三份F2、DESIGN-COMPLIANCE与required CI在M1 PR闭合 | design_ready | none |
...
| `SIM-P-062` | `F-061..070` | K2-A-M1将repository从3102行单文件拆为38行唯一public façade、shared DB owner、唯一projection/schema authority和event/delivery、transition/outbox/callback、timer/session/recovery私有模块；27个public方法、30个private helper、public signature、identity/hash、SQL/lock/CAS/fencing、transaction/readback、migration与业务语义不变，无第二repository或fallback | `test_kernel_repository_structure.py` RED=`3 passed,1 failed`后GREEN=`4 passed`；contracts/DEV repository/DEV migration/import=`33/12/11/66 passed`、combined=`49 passed`、aggregate line/branch=`87.83%/72.04%`、MiniQMT L2=`723 passed,21 skipped`；public signature SHA-256=`7045f3c2...`，migration triplet=`785d438d.../f6331a8a.../7ab20353...`；classifier仅MiniQMT且ownership=`8 mapped,0 unmapped,0 ambiguous` | IMPLEMENTED_VERIFIED | `source_merge=pending_user_authorization`；K2-A仍=`implemented_verified + merged`；K2 overall=`implementation_in_progress`；K2-B/C/D、K3/K4=`not_started`；shadow-only且产品runtime未切换；production DDL/DML/dependency/config/binding/broker/restart/runtime activation全部`noop` |
