...
| Control | Review result | Implementation evidence |
| --- | --- | --- |
| `no_simplified_delivery` | pass for BUG-794/795 scope；platform remains open | 首分钟 durable recovery 与 SELL child sizing 均有产品实现和正反 direct tests；BUG-795 的 legacy、V24、V25 与 V25.1 non-final/final residual 分支均有直接 oracle；mark/economic coupling 与 runtime policy authority 继续分别保留为 `SIM-P-051/052 REPAIR_REQUIRED`，不把已修 slice 冒充 LocalSIM 全面完成 |
