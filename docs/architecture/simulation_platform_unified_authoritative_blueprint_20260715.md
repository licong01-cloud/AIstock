...
| `F-017` | §5.7、§9 P0-C；`RebalanceIntentService`、`ExecutionPlanCompiler` | frozen target/dropped-position reference identity、new binding/parent、no LEGACY fallback tests | implemented_verified | production binding migration DML 尚未执行 |
