...
| `SIM-P-084` | daily trading context / DB storm remediation design | docs branch；pending user merge approval | DDL/DML noop | runtime not_changed | `F-126..F-129` design_ready；源码 BUG/PR、DEV、重启和正常交易日 evidence 均未开始 |
