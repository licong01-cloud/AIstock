...
| `F-070` | §9 P0-H K2 detailed §11–§13 | command `python -m nox -s miniqmt_execution_runtime_l2`；K2-A direct/DEV PostgreSQL=25 passed、line/branch=88.22/72.96、classifier MiniQMT only/unmapped=0；最终PR CI证据回填K2 checkpoint | design_ready | none |
