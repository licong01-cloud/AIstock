...
| `F-062` | §9 P0-H K2 detailed §4.0–§4.10、§9；strict carriers、repository与migration triplet | `backend/tests/miniqmt_execution_runtime/test_kernel_contracts.py`、`backend/tests/miniqmt_execution_runtime/test_kernel_repository_postgres.py`、`backend/tests/miniqmt_execution_runtime/test_kernel_migration_postgres.py`=`33/12/11 passed`；exact initial/progressed-view retry、callback closure、complete scalar projection/recovery、independent function/catalog proof全绿；catalog/helper/forward SHA-256=`6e4fc4ae.../8d9c8b09.../24b4e189...` | design_ready | none |
...
| `F-064` | §9 P0-H K2 detailed §4.2–4.4、§6.3、§7 | `backend/tests/miniqmt_execution_runtime/test_kernel_contracts.py`与`backend/tests/miniqmt_execution_runtime/test_kernel_repository_postgres.py`验证exact fence/epoch/stale worker、dispatch attempt lease、mapping/outbox/algo原子重算与fault rollback；K2-B target delivery | design_ready | none |
...
| `F-066` | §9 P0-H K2 detailed §4.5–§4.7、§6.4–6.5 | `backend/tests/miniqmt_execution_runtime/test_kernel_contracts.py`与`backend/tests/miniqmt_execution_runtime/test_kernel_repository_postgres.py`验证command-aware SUBMIT/CANCEL、owned broker identity、terminal evidence、unknown/reconcile与post-commit readback；K2-D target dispatcher/reconcile | design_ready | none |
| `F-067` | §9 P0-H K2 detailed §4.8–§4.9、§8 | `backend/tests/miniqmt_execution_runtime/test_kernel_contracts.py`、`backend/tests/miniqmt_execution_runtime/test_kernel_repository_postgres.py`与`backend/tests/miniqmt_execution_runtime/test_plugin_import_boundaries.py`验证真实CalendarSnapshotSet、target-scoped import boundary、SH/SZ/BJ/date/timezone/source/segments与runtime trade-date owner负例；K2-C target clock | design_ready | none |
...
| `F-070` | §9 P0-H K2 detailed §11–§13 | `python -m nox -s miniqmt_execution_runtime_l2`=`719 passed,21 skipped`，`python -m nox -s paper_v2_backend`=`1050 passed,2 skipped,2 xfailed`，`test_plugin_import_boundaries.py`=`66 passed`，coverage=`87.21/72.04`；classifier MiniQMT且unmapped=0，Paper由ownership impact补充；L0/registry与三份F2通过，DESIGN-COMPLIANCE-001与final required CI run `30172230466` green；PR #2729 / merge `0b46f7819f4147c97a36908e25ca948ce5450661` | design_ready | none |
...
| `SIM-P-056` | `F-043..070` | MiniQMT统一kernel/plugin F2蓝图保持唯一权威；K2-A第二轮补修增加 exact initial/progressed-view idempotency、terminal CANCEL outbox不变的later callback closure、complete carrier/scalar projection/recovery closure与code-owned independent catalog/function proof；未启动任何worker或产品route | K2 design PR #2714 / merge `50dbcbf6c5d943944a7c7a0a4e5f3e69f5fbd12e`；K2-A final source HEAD `fc261aaf47a6fade01b1037efd5c8cb8ccda5235`、PR #2729 / merge `0b46f7819f4147c97a36908e25ca948ce5450661`；direct/DEV=`33/12/11`、coverage=`87.21/72.04`、MiniQMT/Paper/L0/registry/F2/DESIGN-COMPLIANCE与final CI run `30172230466`全绿 | IMPLEMENTATION_IN_PROGRESS | K2-A=`implemented_verified + merged`；K2-B/C/D、K3/K4=`not_started`；source merge=`merged_pr_2729`；production DDL/DML/dependency/config/broker/restart/runtime均`noop` |
