...
| `production state separation` | pass | K1–K5 source merge已闭合；K6 design=`design_ready_local_pending_pr`、K6-A/B/C/D implementation=`not_started`；DDL/DML/dependency/config/binding/restart/broker/runtime activation/normal-day observation继续分开且均为`noop/not_run`，产品runtime未切换 |
