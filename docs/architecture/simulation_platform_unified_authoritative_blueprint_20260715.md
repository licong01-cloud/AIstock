...
| `SIM-P-085` | `F-130..F-132` broker-specific daily limit authority | 设计PR #3812 / `7905c0ab`；BUG-1197 P1-A PR #3816 / merge `8e1aecf5`；BUG-1202 P1-B MiniQMT direct authority工作树 | P1-A direct=`77 passed`、CI全绿；P1-B direct V2/quote/batch/query-budget通过，`paper_v2_backend=1130 passed,3 skipped,2 xfailed`，simulation L2首次仅发现并修复旧V1 MiniQMT测试 | P1A_SOURCE_MERGED_RUNTIME_PENDING + P1B_SOURCE_REVIEW_IN_PROGRESS | P1-B PR/CI/merge、P1-C/P1-D、用户restart与正常交易日receipts分别pending；DDL/DML/dependency/config/broker/service-control均noop |
