...
|---|---|---|---|---|
| F-001 | planned `backend/services/advisory_phase0b/contracts.py`, CLI | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#5-输入与身份合同` | design_ready | none |
| F-002 | planned `backend/services/advisory_phase0b/snapshot_reader.py` | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#52-snapshot-authority` | design_ready | none |
| F-003 | existing `backend/services/advisory_phase1/snapshot_writer.py:read_verified_snapshot_parquet_rows` | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#53-必需与可选-logical-roles` | design_ready | none |
| F-004 | planned `backend/services/advisory_phase0b/metrics.py` | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#73-冻结指标族` | design_ready | none |
| F-005 | planned `backend/services/advisory_phase0b/metrics.py` paired-stage functions | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#75-hmm-与-risk-overlay-配对` | design_ready | none |
| F-006 | planned blacklist capability result | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#76-行业黑名单` | design_ready | none |
| F-007 | existing `backend/services/advisory_historical_range/summary_service.py:Phase1WinnerDefinitionV1`, planned adapter | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#78-recall` | design_ready | none |
| F-008 | planned daily aggregation | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#71-评价单元` | design_ready | none |
| F-009 | planned metric result contract | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#81-状态模型` | design_ready | none |
| F-010 | planned sample policy | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#82-门槛继承` | design_ready | none |
| F-011 | planned random/report store | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#77-random5` | design_ready | none |
| F-012 | planned service grouping | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#54-program-与策略包隔离` | design_ready | none |
| F-013 | new isolated module only | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#11-模块与所有权` | design_ready | none |
| F-014 | planned typed errors | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#10-错误可见性` | design_ready | none |
| F-015 | this scope and CLI contract | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#16-production-gates--生产门禁` | design_ready | none |
| F-016 | report recommendation fields | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#9-输出合同` | design_ready | none |
| F-017 | planned request/sample/numeric policy and uncertainty engine | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#79-不确定性与多重检验` | design_ready | none |
| F-018 | planned catalog receipt double-read in `snapshot_reader.py` | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#62-snapshot-catalog-双读确认` | design_ready | none |
| F-019 | planned completion bundle and multi-snapshot atomic service | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#93-report-bundle-与-exact-retry` | design_ready | none |
| F-020 | planned bounded `backend/services/advisory_phase0b/spool.py` | artifact: `docs/architecture/advisory_phase0b_candidate_quality_modelability_f1_design_20260731.md#12-implementation-plan--实施方案` | design_ready | none |
