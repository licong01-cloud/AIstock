...
| QE 自主闭环 | DEF-06 | `backend/services/research_assistant/qe_autonomy/` core/adapter/runtime + `backend/db/migrations/ra_upgrade/003_qe_autonomy.sql` / `qe_autonomous_evolution_runs`; final implementation commit `f661071c` (rebased from `0cb31a5f`); final G1-central `research-assistant-qe-autonomy_20260602_061554_l4_ra-phase6-qe-autonomy_363eede3_runner-validation__f155954f61` on doc HEAD `610de29e`; prior post-rebase `research-assistant-qe-autonomy_20260602_060904_l4_ra-phase6-qe-autonomy_0027fa39_runner-validation__16f1f4ace9`; original acceptance `research-assistant-qe-autonomy_20260602_054125_l4_ra-phase6-qe-autonomy_8c9eba8d_runner-validation__3047350a84` + Codex self-check `research-assistant-qe-autonomy_20260602_052629_l4_ra-phase6-qe-autonomy_70e8f636_runner-validation__247ded8e1c`; production_ddl_gate `required_pending_user_approval` | `test_qe_autonomous_loop.py`, `test_qe_autonomy_ddl_contract.py`, `test_qe_autonomy_budget_guard.py`, `test_qe_autonomy_adapter_contract.py`, `test_qe_autonomy_agent_team_integration.py`, `test_qe_autonomy_external_hypotheses.py`, `test_qe_autonomy_determinism.py`, `test_core_no_adapter_import.py`, `20260602_ra_phase6_qe_autonomy_validation.md` |
