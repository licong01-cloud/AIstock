...
|---|---|---|---|---|
| F-246 | 本文 §§1-2；父蓝图 P0-H..P0-K | artifact: `F:/Dev/AIstock_model_artifacts/advisory_p0h_dual_head_output_constraint_20260825/dual_head_output_constraint_bundles/82afdb81c3164c4a8aeed6d427bafe24c006385c8e87b3779c7dcd217dabc5bb/advancement_receipt.json`; artifact: `F:/Dev/AIstock_model_artifacts/advisory_p0j_selection_prior_residual_20260826/selection_prior_residual_bundles/eb8ade9b8f3594a4bf905d518d19400fd37e149f553451e1c0c934a815e9bb2e/advancement_receipt.json` | DESIGN_READY | none |
| F-247 | `selection_liability_gate_training.py`; bundle model role | `backend/tests/advisory_model_first/test_selection_liability_gate_training.py` | DESIGN_READY | none |
| F-248 | request contracts and pipeline identity verifier | `backend/tests/advisory_model_first/test_selection_liability_gate_contracts.py` | DESIGN_READY | none |
| F-249 | liability label builder and feature boundary | `backend/tests/advisory_model_first/test_selection_liability_gate_training.py` | DESIGN_READY | none |
| F-250 | nested OOF pipeline | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-251 | threshold contract/selector | `backend/tests/advisory_model_first/test_selection_liability_gate_training.py` | DESIGN_READY | none |
| F-252 | entry gate and Selection order adapter | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-253 | coverage/anti-cash receipt | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-254 | outer validation isolation | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-255 | shared policy/public helper reuse | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py`; `backend/tests/advisory_model_first/test_shadow_portfolio_policy.py` | DESIGN_READY | none |
| F-256 | winner/PBO/advancement builder | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-257 | bundle publisher/loader and resource receipt | `backend/tests/advisory_model_first/test_selection_liability_gate_bundle.py` | DESIGN_READY | none |
| F-258 | compatibility and boundary assertions | `backend/tests/advisory_model_first/test_dual_head_output_constraint_bundle.py`; `backend/tests/advisory_model_first/test_grouped_rank_output_constraint_bundle.py`; `backend/tests/advisory_model_first/test_selection_prior_residual_bundle.py` | DESIGN_READY | none |
| F-259 | stage guard and typed negative stop | `backend/tests/advisory_model_first/test_selection_liability_gate_pipeline.py` | DESIGN_READY | none |
| F-260 | 本文 §§13-16；production gates | `backend/tests/scripts/test_aistock_feature_workflow.py`; `python scripts/aistock_feature_workflow.py validate --design docs/architecture/advisory_p0k_selection_preserving_liability_gate_f2_design_20260828.md --tier F2` | DESIGN_READY | none |

## 19. Rollout / rollback

1. 设计 PR 只冻结假设、边界、验收矩阵和父蓝图状态。
2. 后续独立实现 worktree 完成 contracts/training/pipeline/bundle/CLI/tests，多轮审核后再提交源码 PR。
