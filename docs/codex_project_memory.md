...
- Current canonical project development standard as of 2026-05-21: `docs/standards/aistock_development_standard_v1.4_20260521.md`. This is the human-readable authority for Python engineering, quant/trading engineering, QE/warehouse completeness, UI, testing, agent workflow, documentation placement, and detailed-design delivery governance.
- Same-version machine-readable standard: `docs/standards/aistock_development_standard_v1.4_20260521.yaml`. Every enabled rule and manual review control must reference the human standard with `standard_ref`; old machine rules are archived under `docs/standards/archive`.
...
- Canonical project development standard is now `docs/standards/aistock_development_standard_v1.4_20260521.md`, with machine catalog `docs/standards/aistock_development_standard_v1.4_20260521.yaml`; v1.2 is archived under `docs/standards/archive`.
...
- Canonical project development standard is now `docs/standards/aistock_development_standard_v1.4_20260521.md`. It intentionally combines Python engineering rules, quant/trading engineering rules, documentation delivery governance, and detailed-design Main-submission rules into one implementation-facing document. Future standard revisions must create new versioned files and move the previous version to `docs/standards/archive`.
- The current machine-readable guardrail catalog is `docs/standards/aistock_development_standard_v1.4_20260521.yaml`; `scripts/aistock_guardrail_scan.py` defaults to it. The scanner supports regex, path_regex, loop-window DataFrame checks, tracked baseline scan, changed-files scan, JSON output, Markdown summary, and severity fail thresholds.
...
- Development standard upgraded to `docs/standards/aistock_development_standard_v1.4_20260521.md` with machine catalog `docs/standards/aistock_development_standard_v1.4_20260521.yaml`; v1.2 is archived under `docs/standards/archive`. The guardrail scanner default catalog and tests now point to v1.4.
...
- Current canonical project development standard is `docs/standards/aistock_development_standard_v1.4_20260521.md`, with machine catalog `docs/standards/aistock_development_standard_v1.4_20260521.yaml`; v1.3 is archived under `docs/standards/archive`.
