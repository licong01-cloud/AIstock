"""Phase-26 research-only parameter-shape sweep for financial distress score-down rules.
...
DEFAULT_OUTPUT_DIR = Path("reports/event_signal/financial_distress_phase26_parameter_shape_sweep")
DEFAULT_DOC_PATH = Path("docs/analysis/event_signal_financial_distress_phase26_parameter_shape_sweep_result_20260511.md")
DEFAULT_ROOT_ENV = Path("F:/Dev/AIstock/.env")
BENCHMARK_RULE = "loss_to_market_cap_ge_50pct_mv_lt_10bn"
REPORT_VERSION = "financial_distress_phase26_parameter_shape_sweep_v1_20260511"


@dataclass(frozen=True)
class Phase26Summary:
    output_json: str
    output_md: str
...
def run_phase26(args: argparse.Namespace) -> Phase26Summary:
    ...
    output_json = output_dir / "financial_distress_phase26_parameter_shape_sweep.json"
...
def main(argv: Optional[list[str]] = None) -> int:
    summary = run_phase26(parse_args(argv))
