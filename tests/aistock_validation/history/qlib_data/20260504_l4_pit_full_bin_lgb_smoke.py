...
PROVIDER_URI = "/mnt/f/Dev/AIstock/qlib_bin/qlib_bin_pit_full_20180801_20260430"
OUTPUT_JSON = Path("/mnt/f/Dev/AIstock/tests/aistock_validation/history/qlib_data/20260504_l4_pit-full-bin-lgb-smoke-result.json")
OUTPUT_PRED = Path("/mnt/f/Dev/AIstock/tests/aistock_validation/history/qlib_data/20260504_l4_pit-full-bin-lgb-smoke-pred.pkl")

START = "2025-07-01"
END = "2026-04-30"
TRAIN = ("2025-07-01", "2025-12-31")
VALID = ("2026-01-02", "2026-02-27")
TEST = ("2026-03-02", "2026-04-30")
...
BACKTEST = ("2026-03-02", "2026-04-29")
...
def main() -> int:
    ...
    result: dict[str, Any] = {
        ...
        "purpose": "PIT daily Bin full candidate short-window LGB train/backtest usability smoke",
    }
    try:
        ...
        sample_features = D.features(inst, ["$close", "$volume", "$factor", "$limit_up", "$limit_down"], start_time=TEST[0], end_time="2026-03-06", freq="day")
